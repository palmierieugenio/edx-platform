...
class DiscussionNavigationTest(BaseDiscussionTestCase):
    ...
    def test_breadcrumbs_all_threads(self):
        ...
        thread_fixture.push()
        thread_page = DiscussionTabSingleThreadPage(
            self.browser,
            self.course_id,
            self.discussion_id,
            thread_id
        ...
        breadcrumbs = thread_page.q(css=".breadcrumbs .nav-item")
